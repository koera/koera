...
if ($_SESSION["username"] != null) {
    ...
    <html>
        ...
        <body class="hold-transition skin-blue sidebar-mini">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form role="form" method="POST"  id="form_vendeur" action="#" >
                                            <div class="box-body">
                                                <label>Date recette (*) :</label>
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-calendar"></i>
                                                    </div>
                                                    <input type="text" class="form-control" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask name="rc_date" id="rc_date">
                                                </div><!-- /.input group -->
                                                <div class="form-group">
                                                    <label>Montant (*) :</label>
                                                    <input type="text" class="form-control" id="rc_montant" name="rc_montant"  placeholder="Montant(Ar)" required="required">
                                                </div>

                                                <div class="form-group">
                                                    <label>Vendeur (*) :</label>
                                                    <div id="select_vendeur_here"></div>
                                                </div><!-- /.form-group -->
            ...
            <!-- page script -->
            <script src="js/app_rv.js"></script>
